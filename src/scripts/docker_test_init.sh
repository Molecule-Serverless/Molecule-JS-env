...
docker run --rm -it -v $(pwd)/../../molecule-benchmarks/:/home -v $(pwd)/../../molecule-js-env/src/:/env -w /env --entrypoint=/env/scripts/local_test_init.sh ddnirvana/molecule-js-env:v3-node14.16.0
