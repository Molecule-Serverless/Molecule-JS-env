...
docker run --rm --name ipc_stage_test_caller -it -v $MOLECULE_ENV_HOME/../molecule-benchmarks/:/home -v $MOLECULE_ENV_HOME/src/:/env -w /env --entrypoint=/bin/bash ddnirvana/molecule-js-env:v3-node14.16.0 $1
