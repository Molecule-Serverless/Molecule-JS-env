...
./docker_run-IPC-client_arm.sh tests/ipc/chain/front-interact front
sleep 1

./docker_run-IPC-server_arm.sh tests/ipc/chain/front-interact interact 12302
sleep 1

./docker_run-IPC-server_arm.sh tests/ipc/chain/interact-smarthome  smarthome 12303
sleep 1

./docker_run-IPC-server_arm.sh tests/ipc/chain/smarthome-door  door 12304
sleep 1

./docker_run-IPC-server_arm.sh tests/ipc/chain/door-light   light 12305
sleep 1
