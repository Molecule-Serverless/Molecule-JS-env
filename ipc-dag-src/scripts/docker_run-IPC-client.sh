...
docker run --rm -it -p 12301:40041 -v $(pwd)/../../molecule-benchmarks/:/home -v $(pwd)/../../molecule-js-env/src/:/env -w /env --entrypoint=/env/scripts/local_client.sh ddnirvana/molecule-js-env:v3-node14.16.0
