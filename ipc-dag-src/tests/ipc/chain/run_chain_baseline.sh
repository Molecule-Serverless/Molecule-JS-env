...
./docker_run-baseline-client.sh tests/ipc/chain/front-interact alexa-front

./docker_run-baseline-server.sh tests/ipc/chain/front-interact alexa-interact 12302

./docker_run-baseline-server.sh tests/ipc/chain/interact-smarthome  alexa-smarthome 12303

./docker_run-baseline-server.sh tests/ipc/chain/smarthome-door  alexa-door 12304

./docker_run-baseline-server.sh tests/ipc/chain/door-light   alexa-light 12305
...
caller_data=($(cat alexa-front_logs.txt| grep "callee " | awk '{ print $9 }'))
