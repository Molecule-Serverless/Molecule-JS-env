...
function run_test_r(){
	...
	docker run --rm --name test_ipc_caller -it -d -p 12301:40041 -v $MOLECULE_ENV_HOME/../molecule-benchmarks/:/home -v $MOLECULE_ENV_HOME/src/:/env -w /env --entrypoint=/env/scripts/local_ipc_caller.sh ddnirvana/molecule-js-env:v3-node14.16.0-arm tests/ipc/stages/$1
...
function run_test_e(){
	...
	docker run --rm --name test_ipc_callee -it -d -p 12302:40041 -v $MOLECULE_ENV_HOME/../molecule-benchmarks/:/home -v $MOLECULE_ENV_HOME/src/:/env -w /env --entrypoint=/env/scripts/local_ipc_callee.sh ddnirvana/molecule-js-env:v3-node14.16.0-arm tests/ipc/stages/$1
	sleep 1
}
